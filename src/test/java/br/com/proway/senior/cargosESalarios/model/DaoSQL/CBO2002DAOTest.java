...
public class CBO2002DAOTest {
    ...
    public void testBuscarCBO2002PorID() {
    	CBO2002Model novoCBO = new CBO2002Model(765010, "Padronista de chapéus", Insalubridade.Zero.getValor(), Periculosidade.Zero.getValor());
    ...
    public void testAtualizarCBO2002() {
    	CBO2002Model novoCBO = new CBO2002Model(223405, "Farmacêutico", Insalubridade.Vinte.getValor(), Periculosidade.Zero.getValor());
    	CBO2002Model cboAlterado = new CBO2002Model(223405, "Farmacêutico(a)", Insalubridade.Vinte.getValor(), Periculosidade.Zero.getValor());
    ...
    public void testDeletarCBO() {
    	...
    	CBO2002Model novoCBO = new CBO2002Model(351415, "Tabelião substituto", Insalubridade.Zero.getValor(), Periculosidade.Zero.getValor());
    ...
    public void testListarTodosCBOs2002() {
    	CBO2002Model novoCBO = new CBO2002Model(262810, "Dançarino", Insalubridade.Zero.getValor(), Periculosidade.Zero.getValor());
    ...
    public void deleteAll() {
    	CBO2002Model cbo1 = new CBO2002Model(241005, "Advogado", Insalubridade.Zero.getValor(), Periculosidade.Zero.getValor());
    	cbo2002DAO.create(cbo1);
    	CBO2002Model cbo2 = new CBO2002Model(234604, "Professor de língua alema", Insalubridade.Zero.getValor(), Periculosidade.Zero.getValor());
