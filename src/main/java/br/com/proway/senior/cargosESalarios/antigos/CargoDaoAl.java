...
/**
 * Classe DAO do Cargo para persist�ncia dos dados em ArrayList.
 * @author Elton Oliveira, Samuel Levi
 * @version Sprint3:
 * 	- Cria��o e implementa��o dos m�todos.
...
public class CargoDaoAl implements CRUDInterface<CargoModel> {
	 ...
	 * Ler Cargo por ID
	 * 
	 * Procura cargo pelo id e retorna nulo caso n�o encontrado
	 * 
	 * @param id Do cargo
	 * @return null/Cargo
	 */
	 ...
	 * Deleta um cargo
	 * 
	 * Deleta um cargo do banco de dados que � igual ao passado como
	 * parametro
	 * 
	 ...
	 * 
	 * M�todo realiza a limpeza do ArrayList de cargos
