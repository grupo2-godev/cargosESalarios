...
public class PostoDeTrabalhoDaoAl implements CRUDInterface<PostoDeTrabalhoModel> {
	 ...
	 * 
	 * Procura posto de trabalho pelo id e retorna nulo caso n�o encontrado.
	 * 
	 * @param int idPosto
	 ...
	 * os dados anteriores), realizando a atualiza��o dos dados.
	 * 
	 * @param PostoDeTrabalhoModel postoModel
	 * @return boolean
	 *
	 ...
	 * 
	 * M�todo realiza a limpeza do ArrayList de postos
