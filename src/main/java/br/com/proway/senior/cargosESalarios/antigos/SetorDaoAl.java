...
/**
 * Classe DAO do Setor para persist�ncia dos dados em ArrayList.
...
public class SetorDaoAl implements CRUDInterface<SetorModel> {
	 ...
	 * 
	 * @param int id
	 * @return Retorna o setor procurado ou nulo se n�o encontrado
	 */
	 ...
	 * 
	 * M�todo realiza a limpeza do ArrayList de setores
